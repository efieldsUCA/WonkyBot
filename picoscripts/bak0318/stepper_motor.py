...
class StepperMotor:
    def __init__(self, dir_id, step_id, en_id, pulse_width=57) -> None:
        """
...
# Stepper Motor that controls the raising and lowering the mechanism
    s = StepperMotor(
        dir_id=27,
        step_id=26,
        en_id=22,
...
# Stepper Motor that controls the opening and closing of the system
    a = StepperMotor(
    dir_id=13,
    step_id=12,
    en_id=28,
